...
public class Main {
	...
	public static void main(String[] args) {
		...
		ContaEspecial ceLuiz = new ContaEspecial(luiz, 1, 1000.0, 500.0,Categorias.SIMPLES);
		ContaPoupanca cpMaria = new ContaPoupanca(maria, 2, 500.0, 0.02,Categorias.EXECUTIVA);
		ContaEspecial ceApple = new ContaEspecial(apple, 3, 100000.0, 10000.0,Categorias.PREMIUM);
		ContaPoupanca cpPadaria = new ContaPoupanca(padaria, 4, 1500.0, 0.03,Categorias.PERSONALITE);
